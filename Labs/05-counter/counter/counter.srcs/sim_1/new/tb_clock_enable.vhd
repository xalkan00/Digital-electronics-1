...
entity tb_clock_enable is
    -- Entity of testbench is always empty  // sem se nic nepiše
...
begin
    ...
    --------------------------------------------------------------------
    -- Clock generation process  // všechni procesi spusti zarovne 
    --------------------------------------------------------------------
    p_clk_gen : process                           
    begin
    ...
    --------------------------------------------------------------------
    p_reset_gen : process            -- ?as v (ns) mužeme zmenit nahodne podle jak nam simulace ukaže
    begin
        s_reset <= '0';
